function  [gwfparams,this_ISI_before_list] = choose_only_bursts(info,ISI_range, prespike_restriction, postspike_restriction, take_burst_type, gwfparams, nrn_ID)
...
prespike_restriction_first_spikelets = prespike_restriction_2*3;
